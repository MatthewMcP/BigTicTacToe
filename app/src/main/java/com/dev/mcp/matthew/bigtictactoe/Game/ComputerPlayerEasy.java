...
public class ComputerPlayerEasy implements IComputerPlayer {
    protected CellState myMark;
    protected CellState[][] board;

    public ComputerPlayerEasy(CellState marker) {
        myMark = marker;
    }
    ...
    public ComputerPlayerType getPlayerType() {
        return ComputerPlayerType.Easy;
    }

    @Override
    public int getComputerMark(CellState mark) {
        if (mark == CellState.XMark) {
            return R.drawable.cross_ai_easy;
        }
        return R.drawable.circle_ai_easy;
    }

    @Override
    public String getName() {
        return App.getContext().getResources().getString(R.string.computername_easy);
    }
