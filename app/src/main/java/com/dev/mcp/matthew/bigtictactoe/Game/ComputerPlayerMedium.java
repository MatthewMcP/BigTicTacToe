...
public class ComputerPlayerMedium implements IComputerPlayer {
    protected CellState myMark;
    protected CellState[][] board;

    public ComputerPlayerMedium(CellState marker) {
        myMark = marker;
    }
    ...
    public ComputerPlayerType getPlayerType() {
        return ComputerPlayerType.Medium;
    }

    @Override
    public int getComputerMark(CellState mark) {
        if (mark == CellState.XMark) {
            return R.drawable.cross_ai_medium;
        }
        return R.drawable.circle_ai_medium;
    }

    @Override
    public String getName() {
        return App.getContext().getResources().getString(R.string.computername_mediun);
    }
